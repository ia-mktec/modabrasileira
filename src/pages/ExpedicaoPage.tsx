...
const ExpedicaoPage = () => {
  ...
  const [refImageDetalhamento, setRefImageDetalhamento] = useState<string | null>(null);
  ...
  const loadOrdem = async (oc: any) => {
    ...
    setRefImageDetalhamento((foundModelo as any)?.imagem_detalhamento_url || null);
    setSearchOpen(false);
    setIsLoaded(true);
    setDataSaida("");
    setOficina("");
    ...
    <div className="p-4 md:p-6 space-y-4 expedicao-ficha">
      <style>{`
        @media print {
          ...
          .expedicao-ficha .print-dados-img-grid { display: grid !important; grid-template-columns: 55% 45% !important; gap: 6px !important; align-items: stretch !important; }
          .expedicao-ficha .print-dados-img-grid > div:first-child .grid { grid-template-columns: repeat(2, minmax(0,1fr)) !important; gap: 3px !important; }
